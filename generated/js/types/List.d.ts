...
/**
 * Describes a list if items. Can contain links to e.g. fetch the next page in a result set.
 */
export type List = LinkedEntity & {
  /**
   * Items in the list
   */
  items: LinkedEntity[];
...
export type LinkedEntity = VersionedContext & {
  /**
